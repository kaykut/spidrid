...
export const JOURNEY_CERT_DEFINITIONS: JourneyCertDefinition[] = [
  {
    tier: 'speed_reader',
    name: 'Speed Reader',
    description: 'Achieved VS 40 with 600 WPM capability',
    icon: '⚡',
    color: '#fab005',
    vsThreshold: 40,
    speedProofWpm: 600,
  ...
  },
  {
    ...
    description: 'Achieved VS 60 with 900 WPM capability',
    icon: '🚀',
    color: '#69db7c',
    vsThreshold: 60,
    speedProofWpm: 900,
  ...
  },
  {
    tier: 'transcendent',
    name: 'Transcendent',
    description: 'Achieved VS 95 with 1200 WPM capability',
    icon: '🏆',
    color: '#9775fa',
    vsThreshold: 95,
    speedProofWpm: 1200,
...
export const SIMPLE_MILESTONES: SimpleMilestone[] = [
  { wpm: 300, name: 'Pace' },
  { wpm: 450, name: 'Quick' },
  { wpm: 600, name: 'Swift', certTier: 'speed_reader' },
  { wpm: 900, name: 'Rapid', certTier: 'velocity_master' },
  { wpm: 1200, name: 'Blaze', certTier: 'transcendent' },
  { wpm: 1500, name: 'Apex' },
];
